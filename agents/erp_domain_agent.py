...
erp_agent = Agent(
    ...
    🔥 **STRICT DOMAIN-SPECIFIC DATA ACCESS:** You and your sub-agents are STRICTLY LIMITED to accessing data ONLY within the sample_docs/ERP/ directory. You CANNOT access or request data from sample_docs/LIMS/ or sample_docs/DMS/. This is a hard boundary that must never be crossed.
    ...
    **Data Source:** Your operational scope and data access are confined to sample_docs/ERP/.
